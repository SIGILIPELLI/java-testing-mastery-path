---
title: "Learn Software Testing with Java Free: Manual + Automation"
description: "Free software testing and QA course using Java -- manual testing fundamentals plus hands-on automation with JUnit 5, Selenium and TestNG. Part of a free learning library."
---

# Java Testing Mastery Path

A structured, module-wise software testing program that takes you from writing
your first test case on paper to designing a production-grade automation
framework — covering **both manual QA fundamentals and test automation in
Java**, with templates, runnable code, and a hands-on project at the end of
each level.
...
| [Level 3 · Advanced](level-3/index.md) | BDD, CI/CD, mobile, performance | 9 topics + 1 project |
| [Level 4 · Master](level-4/index.md) | Test architecture, strategy & scale | 9 topics + 1 capstone |

## How to use this site

- Work through each level in order — later modules assume earlier ones.
- The manual-testing modules give you real templates (test cases, bug reports,
  traceability matrices) you can reuse on a live project immediately.
- The automation modules have runnable Java code — copy them into a Maven
  project and run with `mvn test`, or paste them into your IDE.
...
Free, structured, module-wise training across languages and platforms:
